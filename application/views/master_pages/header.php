...
<head>
	...
	<!-- App favicon -->
	<link rel="shortcut icon" href="modules/assets/img/favicon/favicon.png">

	<!-- Icon CSS -->
	<link href="modules/assets/css/vendor/materialdesignicons.min.css" rel="stylesheet">
	<link href="modules/assets/css/vendor/remixicon.css" rel="stylesheet">

	<!-- Vendor -->
	<link href="modules/assets/css/vendor/bootstrap.min.css" rel="stylesheet">
	<link href="modules/assets/css/vendor/animate.min.css" rel="stylesheet">
	<link href="modules/assets/css/vendor/owl.carousel.min.css" rel="stylesheet">
	<link href="modules/assets/css/vendor/slick.min.css" rel="stylesheet">
	<link href="modules/assets/css/vendor/swiper-bundle.min.css" rel="stylesheet">
	<link href="modules/assets/css/vendor/nouislider.css" rel="stylesheet">

	<!-- Main CSS -->
	<link id="mainCss" href="modules/assets/css/style.css" rel="stylesheet">
</head>
...
<body data-mn-mode="light">
	...
	<main class="wrapper sb-default">
		...
		<div id="mn-overlay">
			<div class="loader">
				<img src="modules/assets/img/logo/loader.png" alt="loader">
				...
				<ul class="mn-sb-list">
					...
					<li class="mn-sb-item sb-drop-item">
						<a href="javascript:void(0)" class="mn-drop-toggle">
							<img src="modules/assets/img/icons/clothes-2.svg" alt="clothes">
					...
					<li class="mn-sb-item sb-drop-item">
						<a href="shop-right-sidebar.html" class="mn-drop-toggle">
							<img src="modules/assets/img/icons/shoes.svg" alt="clothes">
							<span class="condense">Shoes</span>
						</a>
					</li>
					<li class="mn-sb-item sb-drop-item">
						<a href="shop-right-sidebar.html" class="mn-drop-toggle">
							<img src="modules/assets/img/icons/glasses.svg" alt="glasses">
							<span class="condense">glasses</span>
						</a>
					</li>
					<li class="mn-sb-item sb-drop-item">
						<a href="javascript:void(0)" class="mn-drop-toggle">
							<img src="modules/assets/img/icons/bag.svg" alt="bag">
					...
					<li class="mn-sb-item sb-drop-item">
						<a href="shop-right-sidebar.html" class="mn-drop-toggle">
							<img src="modules/assets/img/icons/hat.svg" alt="hat">
							<span class="condense">Hat</span>
						</a>
					</li>
					<li class="mn-sb-item sb-drop-item">
						<a href="javascript:void(0)" class="mn-drop-toggle">
							<img src="modules/assets/img/icons/makeup.svg" alt="makeup">
					...
					<li class="mn-sb-item sb-drop-item">
						<a href="javascript:void(0)" class="mn-drop-toggle">
							<img src="modules/assets/img/icons/cosmetics.svg" alt="cosmetics">
					...
					<li class="mn-sb-item sb-drop-item">
						<a href="javascript:void(0)" class="mn-drop-toggle">
							<img src="modules/assets/img/icons/cake.svg" alt="Cake">
					...
					<li class="mn-sb-item sb-drop-item">
						<a href="shop-right-sidebar.html" class="mn-drop-toggle">
							<img src="modules/assets/img/icons/bread.svg" alt="Bread">
					...
					<li class="mn-sb-item sb-drop-item">
						<a href="javascript:void(0)" class="mn-drop-toggle">
							<img src="modules/assets/img/icons/tuber.svg" alt="tuber">
					...
					<li class="mn-sb-item sb-drop-item">
						<a href="shop-right-sidebar.html" class="mn-drop-toggle">
							<img src="modules/assets/img/icons/tomato.svg" alt="tomato">
							<span class="condense">Tomato</span>
						</a>
					</li>
					<li class="mn-sb-item sb-drop-item">
						<a href="shop-right-sidebar.html" class="mn-drop-toggle">
							<img src="modules/assets/img/icons/lemon.svg" alt="lemon">
					...
					<li class="mn-sb-item sb-drop-item">
						<a href="shop-right-sidebar.html" class="mn-drop-toggle">
							<img src="modules/assets/img/icons/avocado.svg" alt="avocado">
							<span class="condense">avocado</span>
						</a>
					</li>
					<li class="mn-sb-item sb-drop-item">
						<a href="shop-right-sidebar.html" class="mn-drop-toggle">
							<img src="modules/assets/img/icons/strawberry.svg" alt="strawberry">
							<span class="condense">strawberry</span>
						</a>
					</li>
					<li class="mn-sb-item sb-drop-item">
						<a href="shop-right-sidebar.html" class="mn-drop-toggle">
							<img src="modules/assets/img/icons/cherry.svg" alt="cherry">
							<span class="condense">cherry</span>
						</a>
					</li>
					<li class="mn-sb-item sb-drop-item">
						<a href="shop-right-sidebar.html" class="mn-drop-toggle">
							<img src="modules/assets/img/icons/lychee.svg" alt="Lychee">
			...
			<div class="mn-header">
				<div class="mn-header-items">
					<div class="left-header">
						...
						<a href="index.html" class="logo"><img src="modules/assets/img/logo/logo.png" alt="logo"></a>
