<!-- Footer -->
						...
						<div class="row m-minus-991">
							<div class="col-sm-12 col-lg-3 mn-footer-cat">
								<div class="mn-footer-widget mn-footer-company">
									<img src="modules/assets/img/logo/logo.png" class="mn-footer-logo" alt="footer logo">
									<img src="modules/assets/img/logo/logo-dark.png" class="mn-footer-dark-logo"
										alt="footer logo">
									...
									<div class="mn-app-store">
										<a href="javascript:void(0)" class="app-img">
											<img src="modules/assets/img/footer/android.png" class="adroid" alt="apple">
										</a>
										<a href="javascript:void(0)" class="app-img">
											<img src="modules/assets/img/footer/apple.png" class="apple" alt="apple">
										</a>
									</div>
								</div>
							</div>
								...
								<div class="footer-copy">
									<div class="footer-bottom-copy ">
										<div class="mn-copy">Copyright © <span id="copyright_year"></span>
											<a class="site-name" href="https://www.aidcom.in/" target="_blank">AIDCOM</a> all rights reserved.
										</div>
									</div>
								</div>
								<div class="footer-bottom-right">
									<div class="footer-bottom-payment d-flex justify-content-center">
										<div class="payment-link">
											<img src="modules/assets/img/footer/payment.png" alt="payment">
										</div>
									</div>
								</div>
							</div>
								...
								<div class="single-pro-img single-pro-img-no-sidebar">
									<div class="single-product-scroll">
										<div class="single-slide-quickview owl-carousel">
											<img class="img-responsive" src="modules/assets/img/product/1.jpg"
												alt="product-img-1">
											<img class="img-responsive" src="modules/assets/img/product/2.jpg"
												alt="product-img-1">
											<img class="img-responsive" src="modules/assets/img/product/3.jpg"
												alt="product-img-1">
										</div>
									</div>
								</div>
				...
				<div class="mn-search-list">
					<ul class="mn-search-pro-items">
						<li class="search-sidebar-list">
							<a href="product-detail.html" class="mn-pro-img"><img src="modules/assets/img/product/9.jpg"
									alt="product"></a>
						...
						<li class="search-sidebar-list">
							<a href="product-detail.html" class="mn-pro-img"><img src="modules/assets/img/product/15.jpg"
									alt="product"></a>
							<div class="mn-pro-content">
						...
						<li class="search-sidebar-list">
							<a href="product-detail.html" class="mn-pro-img"><img src="modules/assets/img/product/1.jpg"
									alt="product"></a>
							<div class="mn-pro-content">
				...
				<div class="mn-cart-top">
					...
					<ul class="mn-cart-pro-items">
						<li class="cart-sidebar-list">
							<a href="product-detail.html" class="mn-pro-img"><img src="modules/assets/img/product/11.jpg"
									alt="product"></a>
							<div class="mn-pro-content">
						...
						<li class="cart-sidebar-list">
							<a href="product-detail.html" class="mn-pro-img"><img src="modules/assets/img/product/5.jpg"
									alt="product"></a>
							<div class="mn-pro-content">
						...
						<li class="cart-sidebar-list">
							<a href="product-detail.html" class="mn-pro-img"><img src="modules/assets/img/product/13.jpg"
									alt="product"></a>
							<div class="mn-pro-content">
						...
						<li class="cart-sidebar-list">
							<a href="product-detail.html" class="mn-pro-img"><img src="modules/assets/img/product/2.jpg"
									alt="product"></a>
							<div class="mn-pro-content">
	...
	<!-- Vendor Custom -->
	<script src="modules/assets/js/vendor/jquery-3.7.1.min.js"></script>
	<script src="modules/assets/js/vendor/bootstrap.bundle.min.js"></script>
	<script src="modules/assets/js/vendor/owl.carousel.min.js"></script>
	<script src="modules/assets/js/vendor/slick.min.js"></script>
	<script src="modules/assets/js/vendor/swiper-bundle.min.js"></script>
	<script src="modules/assets/js/vendor/countdownTimer.js"></script>
	<script src="modules/assets/js/vendor/infiniteslidev2.js"></script>
	<script src="modules/assets/js/vendor/nouislider.js"></script>
	<script src="modules/assets/js/vendor/smoothscroll.min.js"></script>
	<script src="modules/assets/js/vendor/jquery.zoom.min.js"></script>

	<!-- Main Custom -->
	<script src="modules/assets/js/main.js"></script>
	<script src="modules/assets/js/script.js"></script>
</body>
